...
plt_map1 = map.contourf(xx, yy, psi_200_i, levels=levels_200_i, cmap="bwr")
...
plt.xlabel(u'Longitude', fontname='Liberation Serif', labelpad=20, fontsize=font_size, fontweight='bold')
plt.ylabel(u'Latitude', fontname='Liberation Serif', labelpad=30, fontsize=font_size, fontweight='bold')    
cbar = plt.colorbar(plt_map1)
cbar.ax.tick_params(labelsize=font_size)

ax = fig.add_subplot(2, 1, 2)   
map, xx, yy = basemap(lat, lon)
plt_map1 = map.contourf(xx, yy, psi_200_ii, levels=levels_200_ii, cmap="bwr")
