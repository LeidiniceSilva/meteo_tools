...
for var in ${var_list[@]}; do
	...
	base_url="https://esgf.ceda.ac.uk/thredds/fileServer/esg_cmip6/CMIP6/CMIP/${mdl_family}/${mdl}/${exp}/${member}/day/${var}/${type}/${version}"
	dir="/home/mda_silv/clima-archive2-b/ETCCDI_paper/CMIP6/${mdl}"

	for year in "${YEARS[@]}"; do

		if [ ${mdl} == 'EC-Earth3' ] || [ ${mdl} == 'EC-Earth3-Veg-LR' ] || [ ${mdl} == 'FGOALS-g3' ]; then
