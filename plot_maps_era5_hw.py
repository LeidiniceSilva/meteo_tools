...
plt.ylabel(u'Latitude', labelpad=30, fontsize=font_size, fontname='Liberation Serif', fontweight='bold')
...
plt.xlabel(u'Longitude', labelpad=15, fontsize=font_size, fontname='Liberation Serif', fontweight='bold')
plt.ylabel(u'Latitude', labelpad=30, fontsize=font_size, fontname='Liberation Serif', fontweight='bold')
